...
public class IntegratedCFDGraphNodeController{
	public static final String FXML_FILE_DIR_STRING = "/builder/visframe/context/scheme/applier/reproduceandinserter/cf/cfd/IntegratedCFDGraphNode.fxml";
	...
	void setManager(IntegratedCFDGraphNodeManager manager) {
		...
		this.dagNodeInforLabel.setText(this.manager.getHostCFReproducingAndInsertionManager().getDagNodeInforStringFunction().apply(this.manager.getNode()));
	}
