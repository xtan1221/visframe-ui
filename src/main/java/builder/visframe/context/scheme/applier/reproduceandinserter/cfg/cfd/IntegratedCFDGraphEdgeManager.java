...
//	public abstract C getController();
	...
	protected void calculateAndSetLayout() {
		...
		this.curve.setControlY1(dependingNodeUpperCenterCoord.getY()-this.hostCFGReproducingAndInsertionManager.getDistBetweenLevels()/2);
		
		this.curve.setControlX2(dependedNodeBottomCenterCoord.getX());
		this.curve.setControlY2(dependedNodeBottomCenterCoord.getY()+this.hostCFGReproducingAndInsertionManager.getDistBetweenLevels()/2);
	}
