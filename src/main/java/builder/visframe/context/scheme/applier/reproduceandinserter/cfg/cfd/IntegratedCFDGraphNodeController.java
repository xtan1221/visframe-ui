...
public class IntegratedCFDGraphNodeController{
	public static final String FXML_FILE_DIR_STRING = "/builder/visframe/context/scheme/applier/reproduceandinserter/cfg/cfd/IntegratedCFDGraphNode.fxml";
	
	/////////////////////////////
	private IntegratedCFDGraphNodeManager manager;
	
	void setManager(IntegratedCFDGraphNodeManager manager) {
		this.manager = manager;
		this.dagNodeInforLabel.setText(this.manager.getHostCFGReproducingAndInsertionManager().getDagNodeInforStringFunction().apply(this.manager.getNode()));
	}
	
	/**
	 * @return the manager
	 */
	public IntegratedCFDGraphNodeManager getManager() {
		return manager;
	}
