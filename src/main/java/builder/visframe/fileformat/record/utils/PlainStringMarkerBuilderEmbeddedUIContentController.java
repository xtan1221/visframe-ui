...
public class PlainStringMarkerBuilderEmbeddedUIContentController extends LeafNodeBuilderEmbeddedUIContentController<PlainStringMarker>{
	public static final String FXML_FILE_DIR_STRING = "/builder/visframe/fileformat/record/utils/PlainStringMarkerBuilderEmbeddedUIContent.fxml";
...
//			this.getOwnerNodeBuilder().updateNonNullValueFromContentController(this.build());
	...
	@Override
	public PlainStringMarkerBuilder getOwnerNodeBuilder() {
		return (PlainStringMarkerBuilder) this.ownerNodeBuilder;
	}
	...
	@Override
	public PlainStringMarker build() {
	...
	@Override
	public void setUIToNonNullValue(PlainStringMarker value) {
