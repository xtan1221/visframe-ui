 ...
 * 
 */
public final class StringStartsWithEvaluatorBuilder extends SimpleStringProcessingEvaluatorBuilder<StringStartsWithEvaluator>{
	/**
	 * whether this {@link StringStartsWithEvaluatorBuilder} is for the conditional evaluator of a {@link PiecewiseFunction};
	 * 
	 ...
	 * @throws SQLException 
	 */
	public StringStartsWithEvaluatorBuilder(
...
//			true//boolean mustBeOfSameOwnerRecordDataWithHostCompositionFunction
	...
	protected void buildGenericChildrenNodeBuilderConstraintSet() {
		...
		GenricChildrenNodeBuilderConstraint<StringStartsWithEvaluator> c1 = new GenricChildrenNodeBuilderConstraint<>(
				...
				set1, 
				e->{
					StringStartsWithEvaluatorBuilder builder = (StringStartsWithEvaluatorBuilder)e;
		...
		GenricChildrenNodeBuilderConstraint<StringStartsWithEvaluator> c2 = new GenricChildrenNodeBuilderConstraint<>(
		...
		GenricChildrenNodeBuilderConstraint<StringStartsWithEvaluator> c3 = new GenricChildrenNodeBuilderConstraint<>(
	...
	public boolean setValue(Object value, boolean isEmpty) throws SQLException, IOException {
		...
		if(isEmpty) {
			...
			if(value==null) {
				...
				StringStartsWithEvaluator stringStartsWithEvaluator = (StringStartsWithEvaluator)value;
				this.targetInputVariableBuilderDelegate.setValue(stringStartsWithEvaluator.getTargetInputVariable(), isEmpty);
				this.substringInputVariableBuilderDelegate.setValue(stringStartsWithEvaluator.getSubstringInputVariable(), isEmpty);
				this.toIgnoreCaseInputVariableBuilderDelegate.setValue(stringStartsWithEvaluator.getToIgnoreCaseInputVariable(), isEmpty);
				this.toIgnoreCaseByDefaultBuilder.setValue(stringStartsWithEvaluator.isToIgnoreCaseByDefault(), isEmpty);
				this.outputVariableBuilder.setValue(stringStartsWithEvaluator.getOutputVariable(), isEmpty);
	...
	@Override
	protected StringStartsWithEvaluator build() {
