...
public class ASelectTypeAndTemplateStepManager extends AbstractProcessStepManager<CompositionFunctionGroup, ASelectTypeAndTemplateStepSettings, ASelectTypeAndTemplateStepController> {
	...
	public static ASelectTypeAndTemplateStepManager singleton() {
		if(SINGLETON==null) {
			...
			SINGLETON.addNextStep(BMakeCompositionFunctionGroupStepManager.singleton());
		}
	...
	protected ASelectTypeAndTemplateStepManager() {
		super(CompositionFunctionGroup.class, ASelectTypeAndTemplateStepController.FXML_FILE_DIR_STRING,DESCRIPTION,DEFAULT_SETTINGS);
	}
	
	
	@Override
	public Integer getCurrentlySelectedNextStepIndex() throws IOException, SQLException {
		return this.getPossibleNextStepList().indexOf(BMakeCompositionFunctionGroupStepManager.singleton());
	}
