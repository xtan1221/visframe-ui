...
public class SelectImportModeStepController extends AbstractProcessStepController<VisScheme,SelectImportModeStepSettings>{
	public final static String FXML_FILE_DIR_STRING = "/core/pipeline/visscheme/steps/SelectImportModeStep.fxml";
