...
public class IntegratedCFDGraphNodeManager{
	private final IntegratedCFDGraphViewerManager hostIntegratedCFDGraphViewerManager;
	 ...
	 */
	public IntegratedCFDGraphViewerManager getHostIntegratedDOSGraphViewerManager() {
		return hostIntegratedCFDGraphViewerManager;
	}
