...
public class SimpleDOSGraphNodeManager{
	private final SimpleDOSGraphViewerManager hostSimpleDOSGraphViewerManager;
	private final DOSNodeImpl node;
	
	///////////////////////////
	private SimpleDOSGraphNodeController controller;
	
	private Set<SimpleDOSGraphNodeManager> dependingNodeManagerSet;
	private Set<SimpleDOSGraphNodeManager> dependedNodeManagerSet;
	///////////
	/**
	 ...
	 * @param node
	 */
	public SimpleDOSGraphNodeManager(
			SimpleDOSGraphViewerManager hostSimpleDOSGraphViewerManager,
			DOSNodeImpl node
			){
		//
		
		this.hostSimpleDOSGraphViewerManager = hostSimpleDOSGraphViewerManager;
		this.node = node;
	 ...
	 */
	public SimpleDOSGraphViewerManager getHostSimpleDOSGraphViewerManager() {
		return hostSimpleDOSGraphViewerManager;
	}
	
	/**
	 * @return the node
	 */
	public DOSNodeImpl getNode() {
		return node;
	}
	 ...
	 */
	public Set<SimpleDOSGraphNodeManager> getDependingNodeManagerSet() {
	 ...
	 */
	public Set<SimpleDOSGraphNodeManager> getDependedNodeManagerSet() {
		return dependedNodeManagerSet;
	}

	
	public void setDependingDAGNodeManagerSet(Set<SimpleDOSGraphNodeManager> dependingNodeManagerSet) {
		this.dependingNodeManagerSet = dependingNodeManagerSet;
	}
	
	public void setDependedDAGNodeManagerSet(Set<SimpleDOSGraphNodeManager> dependedNodeManagerSet) {
	 ...
	 * @return
	 */
	public SimpleDOSGraphNodeController getController(){
		if(this.controller==null) {
			FXMLLoader loader = new FXMLLoader(this.getClass().getResource(SimpleDOSGraphNodeController.FXML_FILE_DIR_STRING));
