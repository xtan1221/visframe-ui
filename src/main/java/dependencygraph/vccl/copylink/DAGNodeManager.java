...
public class DAGNodeManager<V,E>{
	private final CopyLinkAssignerManager<V, E> hostCopyLinkAssingerManager;
	...
	public DAGNodeManager(
			CopyLinkAssignerManager<V, E> hostCopyLinkAssingerManager,
			V node, 
			int copyNumber,
	 ...
	 */
	public CopyLinkAssignerManager<V, E> getHostCopyLinkAssingerManager() {
		return hostCopyLinkAssingerManager;
	}
