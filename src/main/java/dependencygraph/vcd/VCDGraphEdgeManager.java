 ...
 * @param <E>
 */
public class VCDGraphEdgeManager {
	protected final VCDGraphViewerManager hostVCDGraphViewerManager;
	protected final VCDEdgeImpl edge;
...
//	public abstract C getController();
	...
	protected void calculateAndSetLayout() {
		...
		this.curve.setControlY1(dependingNodeUpperCenterCoord.getY()-this.hostVCDGraphViewerManager.getDistBetweenLevels()/2);
		
		this.curve.setControlX2(dependedNodeBottomCenterCoord.getX());
		this.curve.setControlY2(dependedNodeBottomCenterCoord.getY()+this.hostVCDGraphViewerManager.getDistBetweenLevels()/2);
	}
