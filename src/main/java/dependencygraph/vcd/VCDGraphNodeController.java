...
public class VCDGraphNodeController{
	public static final String FXML_FILE_DIR_STRING = "/dependencygraph/vcd/VCDGraphNode.fxml";
	
	/////////////////////////////
	private VCDGraphNodeManager manager;
	
	void setManager(VCDGraphNodeManager manager) {
		this.manager = manager;
		this.dagNodeInforLabel.setText(this.manager.getHostVCDGraphViewerManager().getDagNodeInforStringFunction().apply(this.manager.getNode()));
	}
	
	/**
	 * @return the manager
	 */
	public VCDGraphNodeManager getManager() {
		return manager;
	}
