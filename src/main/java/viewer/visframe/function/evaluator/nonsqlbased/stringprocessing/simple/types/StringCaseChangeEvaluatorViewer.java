...
public class StringCaseChangeEvaluatorViewer extends SimpleStringProcessingEvaluatorViewer<StringCaseChangeEvaluator, StringCaseChangeEvaluatorViewerController>{
	
	public StringCaseChangeEvaluatorViewer(
			StringCaseChangeEvaluator value,
			ComponentFunctionViewerBase<?, ?> hostComponentFunctionViewer) {
		super(value, StringCaseChangeEvaluatorViewerController.FXML_FILE_DIR_STRING, hostComponentFunctionViewer);
