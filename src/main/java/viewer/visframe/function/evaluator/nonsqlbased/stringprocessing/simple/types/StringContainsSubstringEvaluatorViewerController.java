 ...
 *
 */
public class StringContainsSubstringEvaluatorViewerController extends SimpleStringProcessingEvaluatorViewerController<StringContainsSubstringEvaluator>{
	public static final String FXML_FILE_DIR_STRING = "/viewer/visframe/function/evaluator/nonsqlbased/stringprocessing/simple/types/StringContainsSubstringEvaluatorViewer.fxml";
	 ...
	 */
	@Override
	public StringContainsSubstringEvaluatorViewer getViewer() {
		return (StringContainsSubstringEvaluatorViewer)this.viewer;
	}
