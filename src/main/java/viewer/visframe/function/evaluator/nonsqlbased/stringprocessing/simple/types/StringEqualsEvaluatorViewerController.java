 ...
 *
 */
public class StringEqualsEvaluatorViewerController extends SimpleStringProcessingEvaluatorViewerController<StringEqualsEvaluator>{
	public static final String FXML_FILE_DIR_STRING = "/viewer/visframe/function/evaluator/nonsqlbased/stringprocessing/simple/types/StringEqualsEvaluatorViewer.fxml";
	...
	protected void setup() {
		...
		InputVariableViewer<?,?> comparedInputVariableViewer = 
				InputVariableViewerFactory.build(this.getViewer().getValue().getComparedInputVariable(), this.getViewer());
		this.comparedInputVariableViewerHBox.getChildren().add(comparedInputVariableViewer.getController().getRootContainerPane());
	 ...
	 */
	@Override
	public StringEqualsEvaluatorViewer getViewer() {
		return (StringEqualsEvaluatorViewer)this.viewer;
	}
	...
	@FXML
	private HBox comparedInputVariableViewerHBox;
	@FXML
