 ...
 *
 */
public class StringStartsWithEvaluatorViewerController extends SimpleStringProcessingEvaluatorViewerController<StringStartsWithEvaluator>{
	public static final String FXML_FILE_DIR_STRING = "/viewer/visframe/function/evaluator/nonsqlbased/stringprocessing/simple/types/StringStartsWithEvaluatorViewer.fxml";
	 ...
	 */
	@Override
	public StringStartsWithEvaluatorViewer getViewer() {
		return (StringStartsWithEvaluatorViewer)this.viewer;
	}
