...
import viewer.visframe.generic.tree.trim.helper.SiblingReorderPatternViewer;
 ...
 *
 */
public class SiblingNodesReorderOperationViewerController extends VfTreeTrimmingOperationBaseViewerController<SiblingNodesReorderOperation>{
	public static final String FXML_FILE_DIR_STRING = "/viewer/visframe/operation/vftree/trim/SiblingNodesReorderOperationViewer.fxml";
	...
	protected void setup() {
		...
		SiblingReorderPatternViewer siblingReorderPatternViewer = new SiblingReorderPatternViewer(this.getViewer().getValue().getSilbingReorderPattern());
		this.siblingReorderPatternViewerHBox.getChildren().add(siblingReorderPatternViewer.getController().getRootContainerPane());
	}
	

	@Override
	public SiblingNodesReorderOperationViewer getViewer() {
		return (SiblingNodesReorderOperationViewer)this.viewer;
	}
	...
	@FXML
	private HBox siblingReorderPatternViewerHBox;
