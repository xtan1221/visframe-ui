 ...
 *
 */
public class SubTreeOperationViewerController extends VfTreeTrimmingOperationBaseViewerController<SubTreeOperation>{
	public static final String FXML_FILE_DIR_STRING = "/viewer/visframe/operation/vftree/trim/SubTreeOperationViewer.fxml";
	...
	@Override
	public SubTreeOperationViewer getViewer() {
		return (SubTreeOperationViewer)this.viewer;
	}
